...
public class EnderSlimeIslandStructureDynamic extends EnderSlimeIslandStructure {
    ...
    protected ConfiguredFeature<?,?> getTreeFeature (){
        return SlimeIslandReplacement.SINGLE_TREE_ENDERSLIME_CONFIGURED_FEATURE;
    }
